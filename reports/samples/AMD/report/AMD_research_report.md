...
**Where money goes:** Money goes to operating costs, reinvestment, capex, and financing obligations when present.
...
**Capex / R&D pressure:** Capex, manufacturing capacity, and gross-margin recovery are central to the cash-flow story.

**Debt and financing:** Debt-like obligations appear in locked data around 3847000000.0; financing risk should be reviewed in filings.
...
- bank metrics
- generic mature-compounder conclusion


Key questions:

- Is demand durable beyond the current AI/capex cycle?
- Can margins hold as supply expands?
- What data is missing for segment-level evidence?


## 7. Valuation Frame

Use revenue growth, gross margin durability, capex intensity, and valuation premium risk; do not use a target price.
...
- Verify data center / AI revenue split.
- Check gross margin bridge and capacity commentary.
- Review export-control and customer concentration disclosures.
